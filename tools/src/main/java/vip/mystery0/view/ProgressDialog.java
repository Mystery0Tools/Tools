...
public class ProgressDialog extends AlertDialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TypedArray a = mContext.obtainStyledAttributes(null, R.styleable.MAlertDialog, R.attr.alertDialogStyle, 0);
		if (mProgressStyle == STYLE_HORIZONTAL) {
			...
			View view = inflater.inflate(a.getResourceId(
					R.styleable.MAlertDialog_horizontalProgressLayout,
			...
			View view = inflater.inflate(a.getResourceId(
					R.styleable.MAlertDialog_progressLayout,
